...
class Event_model extends CI_Model {
   ...
   {
      $this->db->from('event');
      $this->db->join('category', 'category.id = event. id_category');
      $this->db->where('choice', 'Y');
      $this->db->where('event.is_active', 'Y');
   ...
   public function getAllevent($page)
   {
      $this->db->from('event');
      $this->db->join('category', 'category.id = event. id_category');
      $this->db->where('event.is_active', 'Y');
   ...
   public function getevent($seo_title)
   {
      $this->db->from('event');
      $this->db->join('category', 'category.id = event. id_category');
   ...
   public function   getEvnetByCategory($category, $page)
   {
      $this->db->from('event');
      $this->db->join('category', 'category.id = event. id_category');
      $this->db->where('event.is_active', 'Y');
   ...
   public function countevent($category = null)
   {
      if($category){
