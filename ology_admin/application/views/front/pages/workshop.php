...
<h4>Why these modules:
</h4>
<ul style="list-style-type: none;" class="text-align">
  <li><p class="gal-p text-align">Communicating with Confidence -</p>Sharing one's thoughts with clarity and brevity makes a better
impression on others; this module prepares participants to grow their communication skills.
</li>
<li><p class="gal-p text-align">Public Speaking -</p>Speaking to an audience effectively involves following a structure that can
only be strengthened with guidance and regular practice; this module empowers participants to
approach public speaking in a structured way for assured success.

</li>
<li><p class="gal-p text-align">Success Code - </p>The pursuit of our dreams involves staying disciplined and navigating
challenges with determination; this module reinforces the discipline and determination needed
to chase success.

</li>
<li><p class="gal-p text-align">Young Chef - </p>Exposing youngsters to cooking can help them understand why it's an essential
skill and cultivate a healthier relationship with food; this module encourages them to learn a
useful skill and tweak it to their health goals.

</li>
<li><p class="gal-p text-align">Dining Etiquette -</p>We leave impressions with everything we do including eating; this module
enlightens the participants with the best practices to follow while dining.

</li>
<li><p class="gal-p text-align">Emotional Wellness -</p>Life is more of a mental game and the lack of emotional stability impairs
the quality of our life; this module explains how participants can regulate their emotions.
</li>
<li><p class="gal-p text-align">Personal Accountability -</p>We are our own leaders; this module reiterates how we can be our
own cheerleaders and make ourselves be seen as dependable.

</li>
<li><p class="gal-p text-align">Entrepreneurship - </p>An idea has the potential to grow into a full-fledged business with the right
guidance; this module shares the how-to of entrepreneurship.
</li>
<li><p class="gal-p text-align">Finance Fundamentals -</p> While making wealth is important, so is growing it to support ourselves
further; this module imparts knowledge on the basics & best practices of accumulating and
managing finance.
</li>
<li><p class="gal-p text-align">Personal Grooming & Styling - </p>First impressions do matter; this module focuses on honing our
appearance to look sharper.
       ...
       <!-- <div class="container des">
        <div class="row g-row">
            <h1 class="art-h mb-5">Workshop</h1>
            <div class="col-lg-3 gir-row moz">
                <div class="work-card text-center ">
                 ...
                 <a >   <button class="wrk-btn  mt-4">Join now</button></a>   
                </div>
            </div>
            <div class="col-lg-6 gir-row">
              <div class="work-card text-center ">
               <img src="./assets/img/workca.png" alt="">
               <div class="wor-1">workshop 1</div>
               <p class="wor-p">Lorem ipsium wefu wef wefw wefwhji qwoie jfjowjofj ejfwjoj wjejfowej opklwefijw ojm wefojkwf wkokfoiej weio fwo weofkkojwokef.</p>
       ...
       <div class="container mob">
        <div class="row g-row">
            <h1 class="art-h mb-3">Workshop</h1>
            <div class="col-lg-3 gir-row moz mb-3">
                <div class="work-card text-center ">
                 <img src="./assets/img/rectlo.png" alt="">
                 <div class="wor-1">workshop 1</div>
                 <p class="wor-p">Lorem ipsium wefu wef wefw wefwhji qwoie jfjowjofj ejfwjoj wjejfowej opklwefijw ojm wefojkwf wkokfoiej weio fwo weofkkojwokef.</p>
                 <a >   <button class="wrk-btn  mt-2">Join now</button></a>   
                </div>
            </div>
            <div class="col-lg-6 gir-row mb-3">
              <div class="work-card text-center ">
               <img src="./assets/img/rectlo.png" alt="">
               <div class="wor-1">workshop 1</div>
               <p class="wor-p">Lorem ipsium wefu wef wefw wefwhji qwoie jfjowjofj ejfwjoj wjejfowej opklwefijw ojm wefojkwf wkokfoiej weio fwo weofkkojwokef.</p>
          ...
          <div class="col-lg-3 gir-row mb-3">
            <div class="work-card text-center ">
             <img src="./assets/img/rectlo.png" alt="">
             <div class="wor-1">workshop 1</div>
             <p class="wor-p">Lorem ipsium wefu wef wefw wefwhji qwoie jfjowjofj ejfwjoj wjejfowej opklwefijw ojm wefojkwf wkokfoiej weio fwo weofkkojwokef.</p>
       ...
       <!-- <div class="container  ">
        <div class="row g-row">
            <h1 class="art-h mt-5 mb-3">emotional wellness</h1>
            <div class="col-lg-3 gir-row moz mb-3">
                <div class="gree-card text-center ">
                 <img src="./assets/img/rectlo.png" alt="">
                 <div class="wor-1">workshop 1</div>
                 <p class="wor-p">Lorem ipsium wefu wef wefw wefwhji qwoie jfjowjofj ejfwjoj wjejfowej opklwefijw ojm wefojkwf wkokfoiej weio fwo weofkkojwokef.</p>
                 <a >   <button class="wrk-btn  mt-4">Join now</button></a>   
            ...
            <div class="col-lg-6 gir-row">
              <div class="gree-card text-center mb-3 ">
                <img src="./assets/img/rectlo.png" alt="">
               <div class="wor-1">workshop 1</div>
               <p class="wor-p">Lorem ipsium wefu wef wefw wefwhji qwoie jfjowjofj ejfwjoj wjejfowej opklwefijw ojm wefojkwf wkokfoiej weio fwo weofkkojwokef.</p>
               <a >   <button class="wrk-btn  mt-4">Join now</button></a>   
       ...
       <div class="container">
        <div class="row g-row">
            <h1 class="art-h mt-5 mb-3">culinary</h1>
            <div class="col-lg-3 gir-row moz mb-3">
                <div class="yell-card text-center ">
                  <img src="./assets/img/rectlo.png" alt="">
                 <div class="wor-1">workshop 1</div>
                 <p class="wor-p">Lorem ipsium wefu wef wefw wefwhji qwoie jfjowjofj ejfwjoj wjejfowej opklwefijw ojm wefojkwf wkokfoiej weio fwo weofkkojwokef.</p>
                 <a >   <button class="wrk-btn  mt-4">Join now</button></a>   
       ...
       <div class="container text-center mt-5">
        <div class="row">
          <div class="col-lg-12">
            <h1 class="art-h mb-3">Join us and connect with the girls in our vibrant community</h1>
            <!-- <a href="./gallery-pages/programschool.php"><img class="girls-week ogt-gal"  src="./assets/gallery/2/Frame 1984078058.png" /></a> -->
  ...
  <script>
    ...
    function createEventCard(event) {
      ...
      const image = document.createElement("img");
        image.setAttribute("class", "girls-week ogt-gal");
        image.setAttribute("src", `./backend/uploads/${event.image}`);
        image.setAttribute("alt", `${event.name}`);
        const link = document.createElement("a");
        link.addEventListener("click", function(events) {
        events.preventDefault(); // Prevent the default link behavior
        console.log("Link clicked!");
        localStorage.setItem('workshopImages', JSON.stringify(event));
        window.location.href = "gallery-pages/programschool.php";
        });       
