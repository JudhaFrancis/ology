...
<php lang="en">
      ...
      <div class="container-fluid des">
        <div class="row">
            <div class="col-lg-3">
                <img  class="p-5" src="assets/theme/img/tele 1.png" alt="">
            </div>
            <div class="col-lg-7">
       ...
       <div class="container-fluid mob">
        <div class="row">
            ...
            <div class="col-lg-7 text-center">
              <img  class="mt-2" src="assets/theme/img/tele 1-mob.png" alt="">
<div class="text-center">
       ...
       <div class="container-fluid dost-he mob">
        ...
        <div class="row">
          <dic class="col-lg-12 text-center mt-5">
            <img src="assets/theme/img/school girl22 3-mob.png" alt="">
          </dic>
        </div>
       </div>
