...
<div id="newsletter-popup" class="news-pop"  style="display: none; position: fixed; top: 85%; left: 25%; transform: translate(-50%, -50%); padding: 20px; border-radius: 10px; width: 772.775px; z-index: 1;">
  ...
  <img src="assets/theme/img/newsletter-bg.png" class="des" alt="Background Image" style="width: 772.775px;; height: auto;">
...
">
    ...
    flex-shrink: 0; background: url(assets/theme/img/pop-btn.png) no-repeat; color: white; border: none; border-radius: 5px; cursor: pointer; 
    position: absolute;
    left: 113% !important;
...
<div id="newsletter-popup1" class="newspop"  style="display: none; position: fixed; top: 50%; left: 45%; transform: translate(-50%, -50%); padding: 20px; border-radius: 10px; width: 345px; z-index: 1;">
  ...
  <img src="assets/theme/img/mobile-news-letter.png" class="mob" alt="Background Image" style="width: 345px;
  height: 216px;;
  ...
  <div class="overlay-content">
    ...
    <nav class="navbar navbar-expand-lg navbar-light ">
        <div class="container p-4">
          <a class="navbar-brand" href="home"><img src="assets/theme/img/ologylogo.png"></a>
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <li class="nav-item">
              <a class="nav-link text-center" href="about"> Our story</a>
            </li>
              <li class="nav-item">
                <a class="nav-link text-center" href="workshop"> The Finishing School</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="event">EVENTS</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-center" href="gallery">Photo Booth</a>
              </li>
              <li class="nav-item">
              ...
              <li class="log">
                <a id="in" class="nav-link text-white" href="commonlogin">LOGIN</a>
              </li>
