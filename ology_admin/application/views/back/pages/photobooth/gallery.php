<div class="container">
   <div class="row">
      <div class="col">
         <h3 class="page-header">Management <?= $title ?></h3>
      </div>
   </div>
   <div class="row">
      <div class="col">
   ...
   <div class="row mt-3">
      <div class="col">
         <a href="<?= base_url("gallery/create") ?>" class="btn btn-success btn-sm"><i class="fas fa-plus"></i> Add</a>
   ...
   <div class="table-responsive">
      <table id="tableGallery" class="table table-striped table-bordered" cellspacing="0" width="100%">
         <thead>
            <tr>
               <th style="width: 5%;">#</th>
               <th style="width: 20%;">Gallery Title</th>
   ...
   <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
         <div class="modal-header">
            <h5 class="modal-title" id="modal-title">Edit Gallery</h5>
         ...
         <div class="modal-body">
            <form action="#" id="form" class="form-horizontal">
               ...
               <div class="form-group row">
                  <label for="title" class="col-sm-3 col-form-label">Photo Name</label>
                  <div class="col-sm-9">
