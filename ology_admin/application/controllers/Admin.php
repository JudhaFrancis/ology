...
class Admin extends CI_Controller {
   ...
   public function index()
   {
      ...
      $data['total_event'] = $this->my->countRows('event');
   ...
   {
      $data['title'] = 'Event';
      $data['page'] = 'article/event';
      $data['datatable'] = 'article/event-datatable';
      $this->load->view('back/layouts/app', $data);
   }
   ...
   {
      $data['title'] = 'Gallery';
      $data['page'] = 'photobooth/gallery';
      $data['datatable'] = 'photobooth/gallery-datatable';
      $this->load->view('back/layouts/app', $data);
   }
   ...
   {
      $data['title'] = 'Kategori';
      $data['page'] = 'article/subscriptions';
      $data['datatable'] = 'article/subscriptions-datatable';
      $this->load->view('back/layouts/app', $data);
   }
}
